...
export default function Home({ navigation }: { navigation: any; route?: any }) {
  ...
  const [options, setOptions] = React.useState<ArgsType>({
    appkey:
      'eyJhbGciOiJIUzI1NiJ9..z__-eYU-7k-bRK_L48q4iZ7Qw7BPRdxnL1Scp8DYRpM',
    ticket: '',
    environment: 'HML',
  });
